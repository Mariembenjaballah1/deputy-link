  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        accent: "bg-accent text-accent-foreground hover:bg-accent/90 shadow-[0_4px_20px_hsl(35_95%_55%/0.4)] font-bold transform hover:scale-105",
        glass: "bg-card/50 backdrop-blur-lg border border-border/50 hover:bg-card/70 text-foreground",
        hero: "bg-gradient-to-l from-accent to-amber-400 text-accent-foreground font-bold shadow-[0_4px_20px_hsl(35_95%_55%/0.4)] hover:shadow-lg transform hover:scale-105",
      },
      size: {
